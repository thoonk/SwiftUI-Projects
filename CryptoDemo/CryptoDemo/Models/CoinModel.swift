...
curl --request GET \
     ...
     --header 'x-cg-pro-api-key: CG-UZMsJZw1cyEpY2LHvY2KdyMy    '
*/
...
struct CoinModel: Identifiable, Codable {
    ...
    enum CodingKeys: String, CodingKey {
        ...
        case marketCapChange24H = "marketycap_change_24h"
